...
public
  ...
  TFormListarClientes = class(TForm)
    ...
    procedure CheckBoxCidadeChange(Sender: TObject);
  private
...
begin
  ...
  Cliente.excluido    := cdsClientes.FieldByName('excluido').AsBoolean;
end;
...
procedure TFormListarClientes.CheckBoxCidadeChange(Sender: TObject);
begin
  if not edtFiltroCidade.Text.IsEmpty then
